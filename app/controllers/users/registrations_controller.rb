...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    # @user.build_person_info(person_info_params)
    # binding.pry
    # if  @user.save
    ...
    #   render :new
    # end
    # @person_info = Person_info.new(person_info_params)
  ...
  def create_person_info
    ...
    session["devise.person_info_data"] = {person_info: @person_info.attributes}
  ...
  def create_address
    @user = User.new(session["devise.regist_data"]["user"])
    @person_info = PersonInfo.new(session["devise.person_info_data"]["person_info"])
    ...
    session["devise.person_info_data"]["person_info"].clear
    redirect_to root_path
  end
