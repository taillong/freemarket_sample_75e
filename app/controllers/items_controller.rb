class ItemsController < ApplicationController
  ...
  def item_params
    ...
    params.require(:item).permit(:name, :explanation, :brand_id,:condition_id, :delivery_fee_id, :prefecture_id, :duration_id, :price, :category_id, images_attributes: [:src, :_destroy, :id]).merge(seller_id: current_user.id)
  end
